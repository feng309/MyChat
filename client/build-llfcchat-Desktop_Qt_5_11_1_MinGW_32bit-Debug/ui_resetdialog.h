...
public:
    ...
    void setupUi(QDialog *ResetDialog)
    {
        ...
        user_lb->setObjectName(QStringLiteral("user_lb"));
        ...
        email_lb->setObjectName(QStringLiteral("email_lb"));
        ...
        varify_lb->setObjectName(QStringLiteral("varify_lb"));
        ...
        varify_btn->setObjectName(QStringLiteral("varify_btn"));
        ...
        pwd_edit->setObjectName(QStringLiteral("pwd_edit"));
