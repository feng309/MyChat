...
public:
    ...
    void setupUi(QDialog *FindFailDlg)
    {
        if (FindFailDlg->objectName().isEmpty())
            FindFailDlg->setObjectName(QStringLiteral("FindFailDlg"));
        ...
        fail_tip->setObjectName(QStringLiteral("fail_tip"));
        ...
        fail_tip2->setObjectName(QStringLiteral("fail_tip2"));
        ...
        fail_sure_btn->setObjectName(QStringLiteral("fail_sure_btn"));
