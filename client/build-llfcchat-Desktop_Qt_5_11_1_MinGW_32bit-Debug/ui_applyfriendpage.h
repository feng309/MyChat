...
public:
    ...
    void setupUi(QWidget *ApplyFriendPage)
    {
        if (ApplyFriendPage->objectName().isEmpty())
            ApplyFriendPage->setObjectName(QStringLiteral("ApplyFriendPage"));
        ...
        friend_apply_wid->setObjectName(QStringLiteral("friend_apply_wid"));
        ...
        friend_apply_lb->setObjectName(QStringLiteral("friend_apply_lb"));
        ...
        apply_friend_list->setObjectName(QStringLiteral("apply_friend_list"));
