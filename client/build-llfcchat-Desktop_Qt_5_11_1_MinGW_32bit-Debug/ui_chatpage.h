...
public:
    ...
    void setupUi(QWidget *ChatPage)
    {
        ...
        chat_data_wid->setObjectName(QStringLiteral("chat_data_wid"));
        ...
        title_wid->setObjectName(QStringLiteral("title_wid"));
        ...
        chat_data_list->setObjectName(QStringLiteral("chat_data_list"));

        verticalLayout_2->addWidget(chat_data_list);

        tool_wid = new QWidget(chat_data_wid);
        tool_wid->setObjectName(QStringLiteral("tool_wid"));
        ...
        emo_lb->setObjectName(QStringLiteral("emo_lb"));
        ...
        file_lb->setObjectName(QStringLiteral("file_lb"));
        ...
        send_wid->setObjectName(QStringLiteral("send_wid"));
        ...
        receive_btn->setObjectName(QStringLiteral("receive_btn"));
