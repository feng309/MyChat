...
public:
    ...
    void setupUi(QWidget *AddUserItem)
    {
        if (AddUserItem->objectName().isEmpty())
            AddUserItem->setObjectName(QStringLiteral("AddUserItem"));
        ...
        add_tip->setObjectName(QStringLiteral("add_tip"));
