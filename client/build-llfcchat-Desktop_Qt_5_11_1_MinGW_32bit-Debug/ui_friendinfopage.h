...
public:
    ...
    void setupUi(QWidget *FriendInfoPage)
    {
        if (FriendInfoPage->objectName().isEmpty())
            FriendInfoPage->setObjectName(QStringLiteral("FriendInfoPage"));
        ...
        icon_lb->setObjectName(QStringLiteral("icon_lb"));
        ...
        sex_lb->setObjectName(QStringLiteral("sex_lb"));
        ...
        nick_tip->setObjectName(QStringLiteral("nick_tip"));
        ...
        nick_lb->setObjectName(QStringLiteral("nick_lb"));
        ...
        bak_tip->setObjectName(QStringLiteral("bak_tip"));
        ...
        bak_lb->setObjectName(QStringLiteral("bak_lb"));
        ...
        msg_chat->setObjectName(QStringLiteral("msg_chat"));
        ...
        voice_chat->setObjectName(QStringLiteral("voice_chat"));
        ...
        video_chat->setObjectName(QStringLiteral("video_chat"));
