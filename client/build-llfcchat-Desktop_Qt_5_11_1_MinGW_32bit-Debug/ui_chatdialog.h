...
public:
    ...
    void setupUi(QDialog *ChatDialog)
    {
        ...
        side_head_lb->setObjectName(QStringLiteral("side_head_lb"));
        ...
        side_chat_lb->setObjectName(QStringLiteral("side_chat_lb"));
        ...
        side_contact_lb->setObjectName(QStringLiteral("side_contact_lb"));
        ...
        chat_user_wid->setObjectName(QStringLiteral("chat_user_wid"));
        ...
        search_wid->setObjectName(QStringLiteral("search_wid"));
        ...
        search_list->setObjectName(QStringLiteral("search_list"));

        verticalLayout->addWidget(search_list);

        chat_user_list = new ChatUserList(chat_user_wid);
        chat_user_list->setObjectName(QStringLiteral("chat_user_list"));
        ...
        con_user_list->setObjectName(QStringLiteral("con_user_list"));
        ...
        friend_apply_page->setObjectName(QStringLiteral("friend_apply_page"));
        stackedWidget->addWidget(friend_apply_page);
        friend_info_page = new FriendInfoPage();
        friend_info_page->setObjectName(QStringLiteral("friend_info_page"));
