...
public:
    ...
    void setupUi(QWidget *FriendLabel)
    {
        ...
        FriendLabel->setStyleSheet(QLatin1String("#FriendLabel {\n"
"	background: #daf6e7;\n"
"    color: #48bf56;\n"
"    border-radius: 10px;\n"
"} "));
        ...
        close_wid->setObjectName(QStringLiteral("close_wid"));
        ...
        close_lb->setObjectName(QStringLiteral("close_lb"));
        close_lb->setMinimumSize(QSize(15, 15));
        close_lb->setMaximumSize(QSize(15, 15));
        close_lb->setStyleSheet(QStringLiteral("border-image: url(:/res/tipclose.png);"));
