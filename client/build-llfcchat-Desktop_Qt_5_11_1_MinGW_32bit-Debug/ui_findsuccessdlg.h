...
public:
    ...
    void setupUi(QDialog *FindSuccessDlg)
    {
        if (FindSuccessDlg->objectName().isEmpty())
            FindSuccessDlg->setObjectName(QStringLiteral("FindSuccessDlg"));
        ...
        head_lb->setObjectName(QStringLiteral("head_lb"));
        ...
        add_friend_btn->setObjectName(QStringLiteral("add_friend_btn"));
