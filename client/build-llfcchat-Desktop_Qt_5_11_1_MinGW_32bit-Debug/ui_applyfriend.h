...
public:
    ...
    void setupUi(QDialog *ApplyFriend)
    {
        if (ApplyFriend->objectName().isEmpty())
            ApplyFriend->setObjectName(QStringLiteral("ApplyFriend"));
        ...
        apply_lb->setObjectName(QStringLiteral("apply_lb"));
        ...
        apply_wid->setObjectName(QStringLiteral("apply_wid"));
        ...
        name_ed->setObjectName(QStringLiteral("name_ed"));
        ...
        back_ed->setObjectName(QStringLiteral("back_ed"));
        ...
        lb_group_wid->setObjectName(QStringLiteral("lb_group_wid"));
        ...
        lb_ed->setObjectName(QStringLiteral("lb_ed"));
        ...
        input_tip_wid->setObjectName(QStringLiteral("input_tip_wid"));
        ...
        lb_list->setObjectName(QStringLiteral("lb_list"));
        ...
        more_lb_wid->setObjectName(QStringLiteral("more_lb_wid"));
        ...
        more_lb->setObjectName(QStringLiteral("more_lb"));
        ...
        apply_sure_wid->setObjectName(QStringLiteral("apply_sure_wid"));
