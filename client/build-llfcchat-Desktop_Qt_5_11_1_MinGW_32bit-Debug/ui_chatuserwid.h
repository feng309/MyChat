...
public:
    ...
    void setupUi(QWidget *ChatUserWid)
    {
        if (ChatUserWid->objectName().isEmpty())
            ChatUserWid->setObjectName(QStringLiteral("ChatUserWid"));
        ...
        icon_wid->setObjectName(QStringLiteral("icon_wid"));
        ...
        red_point->setObjectName(QStringLiteral("red_point"));
        ...
        user_info_wid->setObjectName(QStringLiteral("user_info_wid"));
        ...
        user_name_lb->setObjectName(QStringLiteral("user_name_lb"));
        ...
        user_chat_lb->setObjectName(QStringLiteral("user_chat_lb"));
        ...
        time_wid->setObjectName(QStringLiteral("time_wid"));
